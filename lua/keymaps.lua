...
vim.keymap.set("n", "<space>fb", ":Telescope file_browser<CR>", { desc = "File brower" })
...
vim.keymap.set("n", "<leader>cka", "<Cmd>Gitsigns stage_hunk<CR>", { desc = "Git hunk add" })
vim.keymap.set("n", "<leader>ckr", "<Cmd>Gitsigns reset_hunk<CR>", { desc = "Git hunk reset" })
vim.keymap.set("n", "<leader>cku", "<Cmd>Gitsigns undo_stage_hunk<CR>", { desc = "Git hunk unstage" })
vim.keymap.set("v", "<leader>cka", function()
    gitsigns.stage_hunk({ vim.fn.line("."), vim.fn.line("v") })
end, { desc = "Git hunk add" })
vim.keymap.set("v", "<leader>ckr", function()
